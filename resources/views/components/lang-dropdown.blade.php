        ...
        <ul class="lang-dropdown__items">
            <li class="lang-dropdown__item">
                <a href="{{ route(Route::currentRouteName(), Config::get('constants.en')) }}">
                    <img class="lang-dropdown__flag" src="{{ asset('images/flags/en.svg') }}" alt="" /><span class="lang-dropdown__value">{{ Config::get('constants.en') }}</span>
            ...
            <li class="lang-dropdown__item">
                <a href="{{ route(Route::currentRouteName(), Config::get('constants.fr')) }}">
                    <img class="lang-dropdown__flag" src="{{ asset('images/flags/fr.svg') }}" alt="" /><span class="lang-dropdown__value">{{ Config::get('constants.fr') }}</span>
            ...
            <li class="lang-dropdown__item">
                <a href="{{ route(Route::currentRouteName(), Config::get('constants.es')) }}">
                    <img class="lang-dropdown__flag" src="{{ asset('images/flags/es.svg') }}" alt="" /><span class="lang-dropdown__value">{{ Config::get('constants.es') }}</span>
